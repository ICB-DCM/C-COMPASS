...
def modify_table (title, prompt, values, tables_all, pos, q, ask):              # modifies data table after making changes in GUI
...
def create_stats(data_con, params):                                             # summarizes stats
    ...
    stats['filtered'] = pd.DataFrame(columns = ['by ValidValues', 'by count', 'by InnerCorrelation', 'by baseline profiles'], index = index_names)
    return stats
        ...
        [sg.Column(
            layout = [
                [sg.Frame(layout=[                                             ## Data Import Frame
                    [sg.Listbox(size=(65,8), select_mode='single', horizontal_scroll=True, values=[], key='--input_box--'),
                     sg.Column(layout = [[sg.Button('Open...', enable_events=True, key = '--input_open--', button_color = 'grey', size = (6,1), disabled = False)],
                                         [sg.Button('Save...', enable_events=True, key = '--input_save--', button_color = 'grey', size = (6,1), disabled = False)],
                                         [sg.Text('-' *13)],
                                         [sg.Button('Load', enable_events=True, key = '--input_load--', button_color = 'dark green', size = (6,1))],
                                         [sg.Button('Reset', enable_events=True, key = '--input_reset--', disabled=True, button_color = 'dark red', size = (6,1))]
                                         ])],
                ...
                [sg.Frame(layout=[                                             ## Operations Frame
                    [sg.Text('purpose: '),
                     sg.Combo(['for prediction', 'for plots'], default_value='for prediction', size=(20,1), enable_events=True, key = '--preset--', readonly=True, disabled=True)],
                    [sg.Checkbox('pre-scaling - over condition', default=False, enable_events=True, disabled = True, key='--scale1_condition--'),
                     sg.Checkbox('pre-scaling - over replicate', default=True, enable_events=True, disabled = True, key='--scale1_replicate--')],
                    [sg.Checkbox('minimum count of Valid Values (per gradient/replicate):  ', default=True, disabled = True, enable_events=True, key='--missing_active--'),
                     sg.Spin(values=(list(range(1,100))), initial_value='1', size=(4,2), readonly=False, disabled = True, key='--missing_number--')],
                    [sg.Checkbox('found in at least: ', default = True, enable_events = True, disabled = True, key='--min_active--'),
                     sg.Spin(values=(list(range(1,10))), initial_value='3', size=(4,2), readonly=True, disabled = True, key='--min_count--'),
                     sg.Text(' replicates', text_color = 'light grey')],
                    [sg.Checkbox('exclude proteins from worst correlated replicate', default = False, enable_events = False, disabled = True, key='--correl_rep_active--')],
                    [sg.Checkbox('median profile', default=False, enable_events=True, disabled = True, key='--median--', tooltip = ' for consistent/reproducible replicates '),
                     sg.Checkbox('concatenated profiles', default=True, enable_events=True, disabled = True, key='--concat--', tooltip = ' for variations over replicate '),
                     sg.Checkbox('process separately', default=False, enable_events=True, disabled = True, key='--separate--', tooltip = ' for other purposes ')],
                    [sg.Checkbox('post-scaling - MinMax (0-1)', default=False, enable_events=True, disabled = True, key='--scale2_0--'),
                    sg.Checkbox('post-scaling - A=1', default=False, enable_events=True, disabled=True,key='--scale2_1--')],
                    [sg.Checkbox('remove baseline profiles (zeroes)', default = False, disabled = True, key = '--zeros_active--')],
                    [sg.Checkbox('calculate correlations between conditions', default=False, disabled = True, enable_events = False, key='--correl_con_active--')]
                    ],
                          title = 'Operations', size = (580,290)),
                ]]),
            sg.Column(
                layout = [
                    [sg.Frame(layout=[                                         ## Data Definition Frame
                         [sg.Combo((input_paths), size=(75, 1), enable_events=True, key='--definition_path--', readonly=True, disabled=True)],
                         [sg.Table(values = [], num_rows=24, headings=['Sample', 'Condition', 'Replicate', 'Fraction'],
                                   auto_size_columns=False, max_col_width=20, vertical_scroll_only=False, col_widths=[34,10,7,7] , key='--definition_table--')],
                         [sg.Button('Remove', enable_events=True, key = '--definition_remove--', disabled=True, button_color = 'dark red'),
                          sg.Button('Keep', enable_events = True, key = '--definition_keep--', disabled = True, button_color = 'dark grey', tooltip = ' Try to keep gene names! '),
                         sg.Button('Set Condition', enable_events=True, key = '--definition_edit_condition--', disabled=True),
                         sg.Button('Set Replicate', enable_events=True, key = '--definition_edit_replicate--', disabled=True),
                         sg.Button('Set Fractions', enable_events=True, key = '--definition_edit_fractions--', disabled=True),
                         sg.Button('Set Identifier', enable_events=True, key = '--definition_identifier--', disabled=True, button_color = 'grey', tooltip = ' If possible, use protein groups! ')]
                         ],
                              title = 'Data Definition', size = (580,516))
                    ]])],
        [sg.Button('Process!', enable_events=True, key = '--start--', disabled=True, button_color = 'black', size=(8,1)),
          sg.Button('Accept', disabled = True, enable_events = True, key = '--exit--', button_color = 'dark green', size=(8,1)),
          sg.Button('Export', enable_events = True, key = '--export--', button_color = 'grey', disabled=True, size=(8,1)),
          sg.ProgressBar(100, orientation = 'h', size = (60, 2), key = '--progress--', border_width = 2, visible = False),
    ...
    while True:
        ...
        if event_NPC == '--input_load--':                                           # Load Button
            if input_paths:
                ...
                window_NPC['--definition_path--'].Update(values=input_paths, value=input_paths[0])
                for path in input_paths:
                    data_all[path], tables_all[path] = create_data(path)
                    ident_pos[path] = []
                window_NPC['--definition_table--'].Update(values = tables_all[input_list[0]])
                for i in ['--input_load--', '--input_remove--']:
                    window_NPC[i].Update(disabled=True)
                for i in ['--input_reset--',
                          '--definition_path--', '--definition_remove--', '--definition_keep--', '--definition_edit_condition--', '--definition_edit_replicate--', '--definition_edit_fractions--', '--definition_identifier--',
                          '--preset--', '--missing_number--', '--min_count--', '--min_active--', '--missing_active--',
        ...
        if event_NPC == '--input_open--':                                           # open input information
            ...
            if filename:
                ...
                if input_list:
                    window_NPC['--definition_table--'].Update(values = tables_all[input_list[0]])
                    window_NPC['--definition_path--'].Update(values=input_list, value=input_list[0])
                    input_paths = []
                    window_NPC['--input_box--'].Update(values=input_paths)
                    for i in ['--input_load--', '--input_remove--']:
                        window_NPC[i].Update(disabled=True)
        ...
        if event_NPC =='--input_reset--':                                           # Reset Button
            ...
            for i in ['--input_load--', '--input_reset--', '--input_remove--',
                    '--definition_path--', '--definition_remove--', '--definition_keep--', '--definition_edit_condition--', '--definition_edit_replicate--', '--definition_edit_fractions--', '--definition_identifier--',
                    '--preset--', '--scale1_condition--', '--scale1_replicate--', '--missing_active--', '--min_active--', '--missing_number--', '--min_count--', '--correl_rep_active--', '--median--', '--concat--', '--separate--', '--scale2_0--', '--scale2_1--', '--zeros_active--', '--correl_con_active--',
                    '--start--']:
                    window_NPC[i].Update(disabled=True)
        ...
        if event_NPC == '--definition_edit_replicate--':
            values_NPC, tables_all = modify_table ('Set Replicate', 'Replicate Number:', values_NPC, tables_all, 2, 0, 'integer')
            window_NPC['--definition_table--'].Update(values = tables_all[values_NPC['--definition_path--']])
        if event_NPC == '--definition_edit_fractions--':
            values_NPC, tables_all = modify_table ('Set Fractions', 'FIRST Fraction Number:', values_NPC, tables_all, 3, 1, 'integer')
            window_NPC['--definition_table--'].Update(values = tables_all[values_NPC['--definition_path--']])
        if event_NPC == '--definition_edit_condition--':
            values_NPC, tables_all = modify_table ('Set Condition', 'Condition Name:', values_NPC, tables_all, 1, 0, 'string')
            window_NPC['--definition_table--'].Update(values = tables_all[values_NPC['--definition_path--']])
        ...
        if event_NPC == '--median--':
            ...
            window_NPC['--correl_con_active--'].Update(disabled=False, value=True)
        if event_NPC == '--concat--':
        ...
        if event_NPC == '--preset--':
            if values_NPC['--preset--'] == 'for plots':
                ...
                window_NPC['--scale1_replicate--'].Update(value=True, disabled=False)
                ...
                window_NPC['--correl_rep_active--'].Update(value=True, disabled=False)
                ...
                window_NPC['--zeros_active--'].Update(value=True, disabled=False)
                window_NPC['--correl_con_active--'].Update(value=True, disabled=False)
            if values_NPC['--preset--'] == 'for prediction':
                window_NPC['--scale1_condition--'].Update(value=False, disabled=True)
                window_NPC['--scale1_replicate--'].Update(value=True, disabled=True)
                window_NPC['--min_active--'].Update(value=True)
                window_NPC['--min_count--'].Update(value=3)
                window_NPC['--missing_active--'].Update(value=True)
                window_NPC['--missing_number--'].Update(value=1)
                window_NPC['--correl_rep_active--'].Update(value=False, disabled=True)
        ...
        if event_NPC == '--export--':
            ...
            if export_folder:
                ...
                for condition in data_con:
                    data_export = pd.merge(data_export, data_con[condition], left_index = True, right_index = True, how = 'outer')
...
## RUN ANALYSIS:
        ...
        if event_NPC == '--start--':                                            ## START Button
            ...
            if is_ident and is_con and is_rep and is_fract and fract_ok:
                ...
                #------------------------------------------------
                state +=1
                refresh_status(window_NPC, state, fullstate, 'creating dataset...')
                #------------------------------------------------
                ...
                #------------------------------------------------
                state +=1
                refresh_status(window_NPC, state, fullstate, 'filtering by empty profiles...')
                #------------------------------------------------
                ...
                #------------------------------------------------
                state +=1
                refresh_status(window_NPC, state, fullstate, 'filtering by missing values...')
                #------------------------------------------------
                ...
                #------------------------------------------------
                state +=1
                refresh_status(window_NPC, state, fullstate, 'filtering by replicate coverage...')
                #------------------------------------------------
                if values_NPC['--min_active--'] == True:
                    mincount = values_NPC['--min_count--']
                    data_con_fcount, protlist_con, stats = filter_count(data_con, mincount, stats)
                ...
                #------------------------------------------------
                state +=1
                refresh_status(window_NPC, state, fullstate, 'removing worst correlations...')
                #------------------------------------------------
                if values_NPC['--correl_rep_active--'] == True:
                    ...
                    #------------------------------------------------
                    state +=1
                    refresh_status(window_NPC, state, fullstate, 're-calculating inner correlations...')
                    #------------------------------------------------
                    icorr = calculate_icorr(data_con, fracts_corr, protlist_con)
                else:
                    state +=1
                ...
                if values_NPC['--median--'] == True:
                    #------------------------------------------------
                    state +=1
                    refresh_status(window_NPC, state, fullstate, 'creating median profiles...')
                    #------------------------------------------------
                ...
                # create concatenated profiles & scale:
                    ...
                    #------------------------------------------------
                    state +=1
                    refresh_status(window_NPC, state, fullstate, 'creating concatenated profiles...')
                    #------------------------------------------------
                ...
                # create separate profiles:
                    ...
                    #------------------------------------------------
                    state +=1
                    refresh_status(window_NPC, state, fullstate, 'creating separated profiles...')
                    #------------------------------------------------
                ...
                #------------------------------------------------
                state +=1
                refresh_status(window_NPC, state, fullstate, 'scaling profiles...')
                #------------------------------------------------
                if values_NPC['--scale2_1--'] == True:
                ...
                #------------------------------------------------
                state +=1
                refresh_status(window_NPC, state, fullstate, 'removing baseline profiles...')
                #------------------------------------------------
                ...
                #------------------------------------------------
                state +=1
                refresh_status(window_NPC, state, fullstate, 'calculating outer correlations...')
                #------------------------------------------------
