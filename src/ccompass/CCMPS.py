...
def main():
    ...
    while True:
        ...
        if event_CCMPS == "-fractionation_add-":
        ...
        elif event_CCMPS == "-fractionation_remove-":
        ...
        elif event_CCMPS == "-fractionation_path-":
            action.fract_refreshtable(
                window_CCMPS,
                fract_tables[values_CCMPS["-fractionation_path-"]],
            )
        elif event_CCMPS == "-fractionation_edit_remove-":
            ...
            if values_CCMPS["-fractionation_table-"]:
                ...
                messagebox.showerror("Error", "Select (a) row(s).")
        elif event_CCMPS == "-fractionation_parameters-":
            fract_preparams = PPMS.PPMS_exec_fract(fract_preparams)
        elif event_CCMPS == "-fractionation_reset-":
            ...
            if sure == "Yes":
                ...
                pass
        elif event_CCMPS == "-fractionation_start-":
            if fract_paths:
                (
                    fract_data,
                    fract_std,
        ...
        elif event_CCMPS == "-fractionation_summary-":
        ...
        elif event_CCMPS == "-tp_parameters-":
            tp_preparams = PPMS.PPMS_exec_TP(tp_preparams)
        elif event_CCMPS == "-tp_reset-":
            sure = sg.popup_yes_no(
        ...
        elif event_CCMPS == "-tp_export-":
            action.tp_export(tp_data, tp_info)

        elif event_CCMPS == "-marker_add-":
        ...
        elif event_CCMPS == "-marker_remove-":
            try:
        ...
        elif event_CCMPS == "-marker_profiles-":
            if action.check_markers(marker_sets):
                try:
                    marker_list = action.create_markerlist(
                        marker_sets, marker_conv, marker_params
        ...
        elif event_CCMPS == "-marker_accept-":
        ...
        elif event_CCMPS == "-classification_parameters-":
            NN_params = PPMS.PPMS_exec_NN(NN_params)

        elif event_CCMPS == "-classification_MOP-":
            (
                learning_xyz,
                NN_params,
                fract_full_up,
        ...
        elif event_CCMPS == "-classification_reset-":
            svm_marker = svm_test = svm_metrics = learning_xyz = results = (
                comparison
            ) = {}
        ...
        elif event_CCMPS == "-statistic_import-":
            filename = sg.popup_get_file(
                "Import Statistics",
                no_window=True,
                file_types=(("Pickle", "*.pkl"),),
        ...
        elif event_CCMPS == "-statistic_report-":
        ...
        elif event_CCMPS == "-global_report-":
        ...
        elif event_CCMPS == "-statistic_reset-":
            results = comparison = {}
            status["proteome_prediction"] = status[
                "lipidome_prediction"
            ] = status["comparison_global"] = status["comparison_class"] = (
        ...
        elif event_CCMPS == "-export_statistics-":
        ...
        elif event_CCMPS == "-export_comparison-":
            export_folder = sg.popup_get_folder("Export Statistics")
            if export_folder:
                for comb in comparison:
                    fname = (
        ...
        elif event_CCMPS == sg.WIN_CLOSED or event_CCMPS == "Exit":
            break
